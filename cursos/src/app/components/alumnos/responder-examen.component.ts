...
export class ResponderExamenComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.route.paramMap.subscribe((params) => {
      ...
      this.alumnoService.ver(id).subscribe((alumno) => {
        this.alumno = alumno;
        this.cursoService
          .obtenerCursoPorAlumnoId(this.alumno)
          .subscribe((curso) => {
            this.curso = curso;
    ...
    modalRef
      ...
      .subscribe((respuestasMap: Map<number, Respuesta>) => {
        ...
        if (respuestasMap) {
          ...
          this.respuestasService.crear(respuestas).subscribe((rs) => {
  ...
  verExamen(examen: Examen): void {
    this.respuestasService
      .obtenerRespuestasPorAlumnoPorExamen(this.alumno, examen)
      .subscribe((rs) => {
